...
function BudgetCard({ budget, setBudget }: { budget: Budget; setBudget: any }) {
	...
	const [approvedAmount, setApprovedAmount] = useState<string>(
		budget.approvedAmount ? budget.approvedAmount.toString() : ""
	);
	...
	async function saveBudget() {
		setLoading(true);
		const tempApprovedAmount = approvedAmount === "" ? 0 : +approvedAmount;
						...
						<div className="flex flex-col lg:flex-row gap-4 lg:items-center">
							...
							<div className="gap-2 flex flex-col w-full">
								...
								<input
									...
									min={0}
									disabled={
										budget.approvedAmount ? true : false
									}
									autoFocus={true}
								/>
							</div>
							<div className="gap-2 flex flex-col w-full">
								...
								<input
									...
									type="number"
									className={`w-full p-2 bg-gray-600 rounded-lg  text-gray-200`}
									value={spentAmount}
									onChange={(e) =>
